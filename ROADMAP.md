...
- Deploy rearview to Alice (.49) with systemd auto-start
...
- Add NLP intent routing: 'search vectors' / 'find similar'
- Create RearView Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common rearview operations
- Build blackroad-operator CLI commands: `br rearview status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream Qdrant
